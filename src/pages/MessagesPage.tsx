              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                  {messages.map((msg) => {
                    ...
                    const SIGNATURE = "— Generado desde tu perfil";
                    const isAutoGenerated = msg.content.trimEnd().endsWith(SIGNATURE);
                    const displayContent = isAutoGenerated
                    ...
                    return (
                      <div key={msg.id} className={`flex ${isMine ? "justify-end" : "justify-start"}`}>
                        ...
                        >
                          <p className="overflow-wrap-break-word whitespace-pre-wrap">{displayContent}</p>
                          {isAutoGenerated && (
                            <p className={`text-[10px] mt-2 italic ${isMine ? "text-white/70" : "text-muted-foreground"}`}>
